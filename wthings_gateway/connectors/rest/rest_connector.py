...
try:
    ...
    WTUtility.install_package("requests")
    from requests import Timeout, request as regular_request
import requests
...
class RESTConnector(Connector, Thread):
    ...
    def load_endpoints(self):
        ...
        for mapping in self.__config.get("mapping"):
            converter = WTUtility.check_and_import(self._connector_type,
    ...
    def __fill_requests_from_WT(self):
        ...
        for request_section in requests_from_wt:
            for request_config_object in self.__config.get(request_section, []):
                ...
                requests_from_wt[request_section].append(request_dict)
