...
from wthings_gateway.connectors.connector import log
from wthings_gateway.wt_utility.wt_utility import WTUtility
from wthings_gateway.connectors.bacnet.bacnet_utilities.wt_gateway_bacnet_device import BACnetDevice
...
class BACnetApplication(BIPSimpleApplication):
    def __init__(self, connector, configuration):
        try:
            ...
            self.__device = BACnetDevice(self.__config["general"])
