...
try:
    ...
    WTUtility.install_package("opcua")
    from opcua import Client, ua
            ...
            for information in device_info["configuration"][information_type]:
                ...
                for information_node in information_nodes:
                    if information_node is not None:
                        ...
                        log.debug("Data to WaveletThings: %s", converted_data)
                    else:
                ...
                for attribute_update in device_info["configuration"]["attributes_updates"]:
                    ...
                    for attribute_node in attribute_nodes:
                        if attribute_node is not None:
                            self.__available_object_resources[device_name]["variables"].append({attribute_update["attributeOnWaveletThings"]: attribute_node})
                        else:
...
class SubHandler(object):
    ...
    def datachange_notification(self, node, val, data):
        try:
            ...
            log.debug("[SUBSCRIPTION] Data to WaveletThings: %s", converted_data)
        except KeyError:
