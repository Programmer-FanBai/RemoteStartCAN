...
from wthings_gateway.wt_utility.wt_expand_parse import process_extend
...
class RemoteConfigurator:
    ...
    def wt_process_configuration(self, configuration):
    ...
    def send_current_configuration(self):
        try:
            ...
            LOG.debug('Current configuration has been sent to WaveletThings: %s', json_current_configuration)
        except Exception as e:
            LOG.exception(e)
    ...
    def __process_connectors_configuration(self):
        ...
        if self.__safe_apply_connection_configuration():
            ...
            with open(self.__gateway.get_config_path() + "wt_gateway.yaml", "w", encoding="UTF-8") as general_configuration_file:
            ...
            for connector in input_connector_config['wthings']['connectors']:
                for input_connector in input_connector_config[connector['type']]:
                    if input_connector['name'] == connector['name']:
                        ...
                        input_connector["config"]["name"] = connector["name"]
    ...
    def __safe_apply_connection_configuration(self):
        ...
        try:
            ...
            if not connection_state:
                ...
                LOG.info("The gateway cannot connect to the WaveletThings server with a new configuration.")
                return False
            else:
                # self.__old_wt_client.stop()
