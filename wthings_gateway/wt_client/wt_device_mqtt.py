...
class WTDeviceMqttClient:
    ...
    def _on_publish(self, client, userdata, result):
        # log.debug("Data published to WaveletThings!")
        pass
    ...
    def disconnect(self):
        ...
        log.debug("Disconnecting from WaveletThings")
        self.__is_connected = False
            ...
            if not self.__timeout_queue.empty():
                ...
                if item is not None:
                    ...
                    if callback is not None:
                        callback(None, WTTimeoutException("Timeout while waiting for a reply from WaveletThings!"))
            else:
                time.sleep(0.01)
